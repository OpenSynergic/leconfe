...
class PluginManager
{
    ...
    public function getPluginGalleryData()
    {
        return [
            [
                'name' => 'Test',
                'author' => 'OpenSynergic',
                'description' => 'This is the desc about the plugin',
                'version' => '1.0',
                'compability' => '1.0',
                'plugin_url' => 'http://localhost:8000/storage/plugins/Test/Test.zip',
                'image_url' => 'http://localhost:8000/storage/plugins/Test/cover.png',
                'created_at' => '2023-10-31 11:04:31',
                'updated_at' => '2023-10-31 13:58:13',
            ],
            [
                'name' => 'Test Update',
                'author' => 'OpenSynergic',
