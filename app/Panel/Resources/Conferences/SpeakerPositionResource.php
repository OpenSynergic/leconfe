...
class SpeakerPositionResource extends Resource
{
    ...
    protected static ?string $model = SpeakerPosition::class;
            ...
            ->schema([
                TextInput::make('name')
                    ...
                    ->unique(modifyRuleUsing: function (Unique $rule) {
                        return $rule->where('type', 'speaker')->where('conference_id', app()->getCurrentConference()->getKey());
                    }),
            ]);
    }
        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\DeleteAction::make()
                    ->using(function (SpeakerPosition $record, Tables\Actions\DeleteAction $action) {
                        try {
