                ...
                <div @class([
                    ...
                    @if ($activeConference->start_date)
                        <div class="inline-flex items-center space-x-2">
                            ...
                            <time
                                class="text-xs text-secondary">{{ date(setting('format.date'), strtotime($activeConference->start_date)) }}</time>
                        </div>
                    @endif
                            ...
                            <div class="rounded border bg-white p-2">
                                ...
                                @if ($conference->start_date)
                                    <div class="cf-upcomiong-enrollment text-xs">Enrollment start on
                                        {{ date(setting('format.date'), strtotime($conference->start_date)) }}
                                    </div>
                                @endif
