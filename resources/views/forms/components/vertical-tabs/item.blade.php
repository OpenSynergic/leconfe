...
@php
    ...
    $activeItemClasses = 'fi-active fi-tabs-item-active bg-gray-100 text-primary-600 dark:bg-white/5 dark:text-primary-400';
...
<{{ $tag }}
    ...
    {{
        $attributes
            ...
            ->class([
                'fi-tabs-item flex items-center gap-x-2 rounded-lg px-3 py-2 text-sm font-medium outline-none transition duration-300',
