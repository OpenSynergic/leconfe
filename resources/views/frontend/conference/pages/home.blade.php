                ...
                <div class="flex flex-col gap-2 flex-1">
                    @if ($currentConference->date_start)
                        <div class="inline-flex items-center space-x-2">
                            ...
                            <time
                                class="text-xs text-secondary">{{ date(Settings::get('date'), strtotime($currentConference->date_start)) }}</time>
                        </div>
                    @endif
                ...
                <table class="w-full text-sm" cellpadding="4">
                    ...
                    @if ($currentConference->date_start)
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                {{ date(Settings::get('date'), strtotime($currentConference->date_start)) }} - {{ date(Settings::get('date'), strtotime($currentConference->date_end)) }}
                            </td>
                        </tr>
                    @endif
                </table>
