        ...
        <section class="bg-white dark:bg-gray-900 flex justify-center items-center md:p-16">
            <div class="container px-6 py-12 mx-auto">
                ...
                <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
                    ...
                    @if(
                        $currentConference->getMeta('email') ||
                        $currentConference->getMeta('phone') ||
                        $currentConference->getMeta('whatsapp') ||
                    ...
                    <div class="flex flex-col space-y-8 lg:-mt-20">
                        ...
                        <div class="grid grid-cols-1 gap-12 md:grid-cols-2">
                            @if ($currentConference->getMeta('email'))
                                <div>
                                    <span
                                        class="inline-block p-3 text-primary rounded-full bg-gray-50 dark:bg-gray-800">
                            ...
                            @if ($currentConference->getMeta('phone'))
                                <div>
                                    <span
                                        class="inline-block p-3 text-primary rounded-full bg-gray-50 dark:bg-gray-800">
                            ...
                            @endif
                            @if ($currentConference->getMeta('whatsapp'))
                                <div>
                                    <span
                                        class="inline-block p-3 text-primary rounded-full bg-gray-50 dark:bg-gray-800">
                            ...
                            @if ($currentConference->getMeta('address'))
                                <div>
                                    <span
                                        class="inline-block p-3 text-primary rounded-full bg-gray-50 dark:bg-gray-800">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
