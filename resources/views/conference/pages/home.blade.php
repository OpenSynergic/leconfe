<x-website::layouts.main>
    <div class="space-y-2">
                ...
                <div class="flex flex-col gap-2 flex-1">
                    @if ($currentConference->start_date)
                        <div class="inline-flex items-center space-x-2">
                            ...
                            <time
                                class="text-xs text-secondary">{{ date(setting('format.date'), strtotime($currentConference->start_date)) }}</time>
                        </div>
                    @endif
        ...
        @if ($currentConference->start_date || $currentConference->hasMeta('location'))
                ...
                <table class="w-full text-sm" cellpadding="4">
                    ...
                    @if ($currentConference->start_date)
                        <tr>
                            <td>Date</td>
                            <td>:</td>
                            <td>{{ date(setting('format.date'), strtotime($currentConference->start_date)) }}
                            </td>
                        </tr>
                    @endif
                </table>
