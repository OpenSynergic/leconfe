<x-conference::layouts.main>
    <div class="px-6 py-2 mt-6">
        <p class="text-heading text-lg">Current Conference</p>
    </div>
                ...
                <div class="flex flex-col sm:flex-row space-x-4">
                    ...
                    <div class="flex flex-col mt-3 gap-2">
                        @if ($currentConference->hasMeta('description'))
                            <div class="cf-description text-sm text-secondary -mt-2 prose text-justify">
    ...
    <div class="card ps-4">
        <div class="card-body space-y-2">
            <div class="cf-information">
                <p class="pb-3 text-lg text-heading">Information</p>
            ...
            <div class="cf-quota">
                <p class="pb-2 text-lg text-heading">Quota</p>
                <table class="w-full" cellpadding="4">
                    <tr>
            ...
            <div class="cf-contact">
                <h4 class="text-lg text-heading pb-2">Contact</h4>
                <table class="w-full" cellpadding="4">
                    <tr>
    ...
    <div class="card ms-5 lg:w-[90%]">
        <div class="card-body space-y-2">
            <p class="text-lg text-heading">Keynote Speakers</p>

            <div class="cf-speakers">
                <div class="flex flex-wrap gap-9">
                    <div class="flex flex-col space-y-4">
                        <p class="text-sm text-secondary">Opening Speakers</p>
                        <div class="flex items-center space-x-2">
                            <div class="avatar">
                                <div
                    ...
                    <div class="flex flex-col space-y-4">
                        <p class="text-sm text-secondary">Closing Speakers</p>
            ...
            <div class="flex flex-col space-y-2">
                <div class="max-w-[200px]">
                    <p class="text-sm text-secondary">On Stage Speakers</p>
                </div>
    ...
    <div class="card mt-4 px-5">
        <div class="card-body">
            <div class="text-lg text-heading">Registration Fee</div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="flex flex-col gap-4">
                <p class="mb-5 text-center text-lg  text-heading">Sponsored By</p>
