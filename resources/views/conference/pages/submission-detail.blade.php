...
<x-website::layouts.main >
    <div class="p-5">
        ...
        {{-- Contributors --}}
        <div class="mt-1 p-5 bg-slate-100 border border-slate-200 shadow-sm rounded-md grid grid-cols-2 gap-4 text-slate-700 text-sm">
         ...
         <div class="text-slate-800 mt-4">
            ...
            <div class="flex flex-wrap text-xs space-x-2">
                @foreach($submission->tagsWithType('submissionKeywords')->pluck('name') as $keyword)
                    <a href="#" class="bg-slate-100 border border-slate-200 py-1 px-3 rounded-md link-primary flex items-center shadow-sm hover:bg-slate-200 hover:border-slate-300 transition ease-in-out duration-200">
                        {{ $keyword }}
                    </a>
                    <a href="#" class="bg-slate-100 border border-slate-200 py-1 px-3 rounded-md link-primary flex items-center shadow-sm hover:bg-slate-200 hover:border-slate-300 transition ease-in-out duration-200">
                        {{ $keyword }}
