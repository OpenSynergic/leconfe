<div class="navbar-container sticky top-0 z-[500] bg-primary text-white">
    <div class="navbar mx-auto max-w-7xl">
        ...
        <div class="navbar-end gap-x-4 hidden lg:inline-flex">
            ...
            @else
                <x-conference::link :href="route('livewirePageGroup.website.pages.register')" :spa="false" class="btn btn-sm btn-ghost rounded-full px-4">Register</x-conference::link>
                <x-conference::link :href="route('livewirePageGroup.website.pages.login')" :spa="false" class="btn btn-sm rounded-full px-4">Login</x-conference::link>
            @endif
        </div>
    </div>
</div>
